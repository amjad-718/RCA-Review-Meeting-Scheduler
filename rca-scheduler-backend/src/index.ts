...
app.post('/api/extract-rca-owners', async (req, res) => {
  ...
  try {
    ...
    const openai = new OpenAI({ apiKey: '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' });
